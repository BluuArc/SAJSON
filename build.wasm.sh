...
emcc SAJSON-WASM.cpp SuperAnimCore.cpp -o dist/sajson.js -sEXPORTED_FUNCTIONS=_get_sam_json_string,_malloc,_free -sEXPORTED_RUNTIME_METHODS=ccall,cwrap -sALLOW_MEMORY_GROWTH
